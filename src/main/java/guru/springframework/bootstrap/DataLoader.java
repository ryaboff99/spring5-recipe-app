...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private static final String UOM_EXCEPTION = "Expected Unit of Measure Not Found";
    private static final String CATEGORY_EXCEPTION = "Expected Category Not Found";
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.setIngredients(Set.of(new Ingredient("Chili powder", BigDecimal.valueOf(2),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Tablespoon")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Oregano", BigDecimal.valueOf(1),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Teaspoon")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Cumin", BigDecimal.valueOf(1),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Teaspoon")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Sugar", BigDecimal.valueOf(1),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Teaspoon")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Kosher salt", BigDecimal.valueOf(0.5),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Teaspoon")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Garlic", BigDecimal.valueOf(1),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Сlove")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Orange zest", BigDecimal.valueOf(1),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Tablespoon")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Orange juice", BigDecimal.valueOf(3),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Tablespoon")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Olive oil", BigDecimal.valueOf(2),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Tablespoon")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Chicken thighs", BigDecimal.valueOf(1),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Pound")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Corn tortillas", BigDecimal.valueOf(8),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Unit")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Arugula", BigDecimal.valueOf(3),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Cup")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Ripe avocado", BigDecimal.valueOf(2),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Unit")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Radish", BigDecimal.valueOf(4),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Unit")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Cherry tomatoes", BigDecimal.valueOf(0.5),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Pint")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Sliced onion", BigDecimal.valueOf(0.25),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Unit")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Chopped cilantro", BigDecimal.valueOf(1),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Unit")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Sour cream", BigDecimal.valueOf(0.5),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Cup")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Milk", BigDecimal.valueOf(0.5),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Cup")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION))),
                new Ingredient("Lime", BigDecimal.valueOf(1),
                        tacosRecipe, unitOfMeasureRepository.findByDescription("Unit")
                        .orElseThrow(() -> new RuntimeException(UOM_EXCEPTION)))));
        tacosRecipe.setImage(new Byte[]{4, 5, 6});
        tacosRecipe.setNotes(new Notes(tacosRecipe, "Any and every kind of leftover can go inside a warm tortilla, usually with a healthy dose of pickled jalapenos. I can always sniff out a late-night snacker when the aroma of tortillas heating in a hot pan on the stove comes wafting through the house. Today's tacos are more purposeful a deliberate meal instead of a secretive midnight snack! First, I marinate the chicken briefly in a spicy paste of ancho chile powder, oregano, cumin, and sweet orange juice while the grill is heating. You can also use this time to prepare the taco toppings. Grill the chicken, then let it rest while you warm the tortillas. Now you are ready to assemble the tacos and dig in. The whole meal comes together in about 30 minutes!  The ancho chiles I use in the marinade are named for their wide shape. They are large, have a deep reddish brown color when dried, and are mild in flavor with just a hint of heat. You can find ancho chile powder at any markets that sell Mexican ingredients, or online. I like to put all the toppings in little bowls on a big platter at the center of the table: avocados, radishes, tomatoes, red onions, wedges of lime, and a sour cream sauce. I add arugula, as well—this green isn't traditional for tacos, but we always seem to have some in the fridge and I think it adds a nice green crunch to the tacos. Everyone can grab a warm tortilla from the pile and make their own tacos just they way they like them. You could also easily double or even triple this recipe for a larger party. A taco and a cold beer on a warm day? Now that's living!"));
        tacosRecipe.setDifficulty(Difficulty.MODERATE);
        tacosRecipe.setCategories(Set.of(categoryRepository.findByDescription("Mexican")
                        .orElseThrow(() -> new RuntimeException(CATEGORY_EXCEPTION)),
                categoryRepository.findByDescription("Fast Food")
                        .orElseThrow(() -> new RuntimeException(CATEGORY_EXCEPTION))));
